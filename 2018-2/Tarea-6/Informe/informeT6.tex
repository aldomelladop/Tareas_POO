...
\lstinputlisting[language = C++,firstline = 356, lastline =382] {./codes/tarea6.cpp}
...
\lstset{style=mystyle, language = C++}
\lstinputlisting[language = C++,firstline = 430, lastline =481] {./codes/tarea6.cpp}
...
\lstset{style=mystyle, language = C++}
\lstinputlisting[language = C++,firstline = 293, lastline =309] {./codes/tarea6.cpp}
}
...
\lstset{style=mystyle, language = C++}
\lstinputlisting[language = C++,firstline = 300, lastline =307] {./codes/tarea6.cpp}
...
\centering
\subfigure[Cuadro de diálogo desplegado]{\includegraphics[scale=0.4]{./imagenes/captura}}
\end{figure}
\end{document}